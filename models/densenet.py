...
From https://github.com/alinlab/cs-kd/blob/master/models/densenet3.py
'''
import math
import torch
...
class CIFAR_DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=10, bias=True):
        ...
        self.fc = nn.Linear(num_planes, num_classes, bias=bias)
...
def densenet121_cifar(pretrained=False, num_classes=10, bias=True, **kwargs):
